...
// On click action for the top portion of dashboard.
...
//  All the incialation fuction to all the different stages in dashboard.
...
// All the data for sale and total sale .
    fetch_data: function() {
        var self = this;
        var def1 =  this._rpc({
                model: 'pos.order',
...
//    },
      ...
      //  Getting the value for the order today.
